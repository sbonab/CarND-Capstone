...
PUB_RATE = 50  # Rate (Hz) of publishing final waypoints
STOP_LINE_MARGIN = 3  # Margin of waypoints to stop the nose of car at the line
MAX_DECEL = 0.5
